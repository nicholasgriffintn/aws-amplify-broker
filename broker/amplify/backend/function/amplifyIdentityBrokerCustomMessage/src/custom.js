...
function I18N() {
	this.strings = {
		en: {
			...
			EMAIL_MESSAGE:
				"Thank you for creating an account with us. Please click on the below link to confirm the registration!",
		...
		fr: {
			...
			EMAIL_MESSAGE:
				"d'avoir créé un compte avec nous. Veuillez cliquer sur le lien ci-dessous pour confirmer l'inscription!",
		...
		de: {
			...
			EMAIL_MESSAGE:
				"Vielen Dank, dass Sie ein Account bei uns erstellt haben. Bitte klicken Sie auf den unten stehenden Link, um die Registrierung zu bestätigen.",
			SMS_MESSAGE:
				"Klicken Sie auf den folgenden Link, um Ihre Angaben zu überprüfen: ",
			EMAIL_SUBJECT:
				"Erforderliche Aktion: Überprüfen Sie Ihre Kontaktinformationen.",
			EMAIL_LINK: "Hier klicken",
		},
		nl: {
			EMAIL_GREETING: "Hallo",
			EMAIL_MESSAGE:
				"dBedankt voor het aanmaken van een account bij ons. Klik op de onderstaande link om de registratie te bevestigen.",
			SMS_MESSAGE:
				"Klik op deze link om uw contactgegevens te verifiëren: ",
 ...
 <head>
     ...
     <style type="text/css">
         ...
         .buttonComponent {
             ...
             border-color: #032169;
             border-width: 1px;
             background: #032169 linear-gradient(#032169, #032169) repeat scroll 0%=0%;
         ...
         <tbody>
             <tr>
                 <td style="width:100%; vertical-align:middle;" align="center" valign="middle" width="100%" height="27">
                     <a class="buttonComponentLink" href="${link}"> ${translator.get(
		"EMAIL_LINK"
	)} </a>
                 </td>
             </tr>

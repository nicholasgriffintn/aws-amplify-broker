...
var OLD_CLIENTID = "3ve2pm4a2c8hosjq1jf9ml202q";
// Fill in UserPoolID about your Idenity Provider you are trying to migrate from
var OLD_USERPOOLID = "eu-west-1_ikMKshN4Q";
		...
		cognitoidentityserviceprovider.initiateAuth(
			...
			function (err, data) {
				if (data) {
					// successful response
					console.log(
						"Verified user with existing system: " + event.userName
					);

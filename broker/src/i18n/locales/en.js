...
export const i18nStrings = {
	...
	LANDING_PAGE_BUTTON_IDP_AWSSSO_LABEL: "AWS SSO (SAML)",
	LANDING_PAGE_BUTTON_IDP_OIDCIdentityProvider_LABEL: "Demo OIDC (oauth2)",
	LANDING_PAGE_BUTTON_IDP_APPLE_SIGNIN_LABEL: "Apple",
	LANDING_PAGE_BUTTON_IDP_AMAZON_SIGNIN_LABEL: "Amazon",
	LANDING_PAGE_BUTTON_IDP_GOOGLE_SIGNIN_LABEL: "Google",
	LANDING_PAGE_BUTTON_IDP_FACEBOOK_SIGNIN_LABEL: "Facebook",
	LANDING_PAGE_DIVIDER_TEXT: "or sign in with",
	LANDING_PAGE_CHIP_EXPAND_MORE_LABEL: "more",
	LANDING_PAGE_CHIP_EXPAND_LESS_LABEL: "less",
	LANDING_PAGE_WAIT_REDIRECTION:
		"You have successfully logged in, please wait while we redirect you...",

	// ./components/RegisterConfirm/RegisterConfirm.js
	REGISTER_CONFIRM_EMAIL_LABEL:
	...
	TAB_DEVICE_DATA_TEXTFIELD_LAST_MODIFIED_LABEL:
		"Device last times modified at",
	...
	TAB_MFA_DATA_SELECT_SMS_NOT_VERIFIED:
		"SMS (please verify your Phonenumber first)",
	...
	TAB_MFA_DATA_MESSAGE_VERIFY_TOTP_TOKEN_SUCCESS:
		"Configuration of TOTP was successful",
	...
	TAB_SIGNIN_DATA_MESSAGE_UPDATE_ATTRIBUTE_SUCCESS:
		"The update was successful",
	TAB_SIGNIN_DATA_MESSAGE_UPDATE_ATTRIBUTE_VERIFYCATION_REQUEST:
		"Please verify your changes",
	TAB_SIGNIN_DATA_MESSAGE_PASSWORD_CHANGE_SUCCESS:
		"The password was successful set",
	TAB_SIGNIN_DATA_MESSAGE_VERIFY_ATTRIBUTE_MESSAGE_SUCCESS:
		"The verification was successful",
	TAB_SIGNIN_DATA_MESSAGE_EMAIL_VALIDATION_ERROR: "Invalid E-Mail Address",
	TAB_SIGNIN_DATA_MESSAGE_PHONE_NUMBER_VALIDATION_ERROR:
		"Invalid Phone number. A phone number can only contain the + sign and digits",
	...
	TAB_USER_DATA_SELECT_GENDER_3: "Other / Prefer not to say",
	...
	TERMS_OF_SERVICE_MESSAGE_RESIGN:
		"Please read and accept the Terms of Service",
	TERMS_OF_SERVICE_MESSAGE_ACCEPTED:
		"The Terms of Service successfully accepted.",
	...
	PRIVACY_POLICY_CONTENT_TITLE: "Privacy Policy",
	TERMS_OF_SERVICE_CONTENT_P1:
		"Please read our full Terms of Use policy here: https://example.com/terms-of-use and our full Privacy Policy here: https://example.com/privacy-policy",
	...
	MFA_TOTP_CONFIG_DIALOG_DESCRIPTION:
		"Multi-Factor Authentication (MFA) enhances security by adding another authentication method rather than relying solely on username and password.",
	MFA_TOTP_CONFIG_DIALOG_STEP1_LABEL: "TOTP Request Token",
	MFA_TOTP_CONFIG_DIALOG_STEP1_DESCRIPTION:
		"You can use time-based one-time passwords (TOTP) as second factors when your users log in.",
	MFA_TOTP_CONFIG_DIALOG_STEP1_BUTTON_TOKEN_REQUEST_LABEL:
		"Request TOTP Token",
	MFA_TOTP_CONFIG_DIALOG_STEP2_LABEL: "TOTP Device Setup",
	MFA_TOTP_CONFIG_DIALOG_STEP2_DESCRIPTION:
		"Scan the QR-Code with your Device",
	MFA_TOTP_CONFIG_DIALOG_STEP3_LABEL: "TOTP Device Activate",
	MFA_TOTP_CONFIG_DIALOG_STEP3_DESCRIPTION:
		"Activate your Device by entering the One-Time-Password and click 'Activate'",
	MFA_TOTP_CONFIG_DIALOG_STEP3_TEXTFIELD_VERIFY_CODE_LABEL:
		"One-Time-Password",

...
const mapStateToProps = (state) => {
	return {
		...
		phone_number_verified:
			state.user.attributes.phone_number_verified || false,
	};
};
			...
			case "email":
				if (validateEmailAddress(props.email)) {
					...
					setSnackBarOps({
						...
						autoHide: 3000,
						message: I18n.get(
							"TAB_SIGNIN_DATA_MESSAGE_EMAIL_VALIDATION_ERROR"
						),
					});
				}
				break;
		...
		<div>
			...
			{passwordChange && (
				<ChangePasswordDialog
					open={passwordChange}
					close={(successful) =>
						handleClosePasswordDialog(successful)
					}
				/>
			)}
					...
					<Box className={classes.boxInputField}>
						<FormControl className={classes.formControl}>
							<InputLabel htmlFor="inputUsername">
								{I18n.get(
									"TAB_SIGNIN_DATA_USERNAME_INPUT_LABEL"
								)}
							</InputLabel>
							<Input
					...
					<Box className={classes.boxInputField}>
											...
											{props.email &&
												props.email_verified && (
													<Chip
														size="small"
														label={I18n.get(
															"TAB_SIGNIN_DATA_CHIP_VERIFIED_LABEL"
														)}
														className={
															classes.chipVerified
														}
													/>
												)}
											{props.email &&
												!props.email_verified && (
													<Chip
														size="small"
														label={I18n.get(
															"TAB_SIGNIN_DATA_CHIP_UNVERIFIED_LABEL"
														)}
														onClick={() =>
						...
						{editEmail && (
							<div>
								...
								>
									{I18n.get(
										"TAB_SIGNIN_DATA_SAVE_BUTTON_LABEL"
									)}
								</Button>
								<Button
									variant="outlined"
									onClick={() =>
										handleAttributeCancel("email")
									}
									className={classes.buttonCancel}
								>
									{I18n.get(
										"TAB_SIGNIN_DATA_CANCEL_BUTTON_LABEL"
									)}
								</Button>
							</div>
						)}
					...
					<Box className={classes.boxInputField}>
						<FormControl className={classes.formControl}>
							<InputLabel htmlFor="inputPhoneNumber">
								{I18n.get(
									"TAB_SIGNIN_DATA_PHONENUMBER_INPUT_LABEL"
								)}
							</InputLabel>
							<Input
						...
						{editPhoneNumber && (
							<div>
								<Button
									variant="outlined"
									onClick={() =>
										handleAttributeSave("phone_number")
									}
									className={classes.buttonSave}
								>
									{I18n.get(
								...
								<Button
									variant="outlined"
									onClick={() =>
										handleAttributeCancel("phone_number")
									}
									className={classes.buttonCancel}
								>
									{I18n.get(

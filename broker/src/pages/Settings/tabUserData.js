...
const mapStateToProps = (state) => {
	return {
		 ...
		 */
		custom_newsletter:
			state.user.attributes["custom:newsletter"] || "false",
	};
};
...
const TabUserData = (props) => {
				...
				Auth.updateUserAttributes(CognitoUser, attributes)
					.then(() => {
						setSnackBarOps({
							...
							autoHide: 3000,
							message: I18n.get(
								"TAB_USER_DATA_MESSAGE_UPDATE_ATTRIBUTE_SUCCESS"
							),
						});
	...
	const handleAttributeChange = (attr, value) => {
		...
		try {
			 ...
			 */
			if (attr === "locale" && props.lang !== value) props.setLang(value);
				...
				<CardContent className={classes.cardContent}>
					<form noValidate autoComplete="off">
						<Box>
							<FormControl className={classes.formControl}>
								<TextField
									...
									label={I18n.get(
										"TAB_USER_DATA_TEXTFIELD_GIVEN_NAME_LABEL"
									)}
						...
						<Box>
							<FormControl className={classes.formControl}>
								<TextField
									...
									label={I18n.get(
										"TAB_USER_DATA_TEXTFIELD_FAMILY_NAME_LABEL"
									)}
									className={classes.textField}
									onChange={(event) =>
										handleAttributeChange(
						...
						<Box>
							<FormControl className={classes.formControl}>
								<TextField
									...
									rows={3}
									label={I18n.get(
										"TAB_USER_DATA_TEXTFIELD_ADDRESS_LABEL"
									)}
									className={classes.textField}
									onChange={(event) =>
										handleAttributeChange(
						...
						<Box>
							<FormControl className={classes.formControl}>
								<TextField
									...
									label={I18n.get(
										"TAB_USER_DATA_TEXTFIELD_BIRTHDATE_LABEL"
									)}
									type="date"
									onChange={(event) =>
										handleAttributeChange(
						...
						<Box>
							<FormControl className={classes.formControl}>
								<InputLabel
									id="textfield_gender_label"
									className={classes.inputLableGender}
								>
									{I18n.get(
										"TAB_USER_DATA_TEXTFIELD_GENDER_LABEL"
									)}
								</InputLabel>
								<Select
								...
								>
									<MenuItem value={0}>
										{I18n.get(
											"TAB_USER_DATA_SELECT_GENDER_0"
										)}
									</MenuItem>
									<MenuItem value={1}>
										{I18n.get(
											"TAB_USER_DATA_SELECT_GENDER_1"
										)}
									</MenuItem>
									<MenuItem value={2}>
										{I18n.get(
											"TAB_USER_DATA_SELECT_GENDER_2"
										)}
									</MenuItem>
									<MenuItem value={3}>
										{I18n.get(
											"TAB_USER_DATA_SELECT_GENDER_3"
										)}
									</MenuItem>
								</Select>
							</FormControl>
						...
						<Box>
							<FormControl className={classes.formControl}>
								<InputLabel
									id="textfield_language_label"
									className={classes.inputLableGender}
								>
									{I18n.get(
										"TAB_USER_DATA_TEXTFIELD_LANGUAGE_LABEL"
									)}
								</InputLabel>
								<Select
						...
						<FormGroup row>
							<FormControlLabel
								...
								label={I18n.get(
									"TAB_USER_DATA_TEXTFIELD_CUSTOM_NEWSLETTER_LABEL"
								)}
							/>
						</FormGroup>
					</form>

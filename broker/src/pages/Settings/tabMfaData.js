					...
					.then((data) => {
						...
						if (data === "SUCCESS")
							setSnackBarOps({
								...
								autoHide: 3000,
								message: I18n.get(
									"TAB_MFA_DATA_MESSAGE_SET_MFATYPE_SUCCESS"
								),
							});
	...
	return (
		<div className={classes.root}>
			...
			{totpDialog && (
				<MfaTotpConfigDialog
					open={totpDialog}
					close={(successful) => handleTotpDialogClose(successful)}
				/>
			)}
						...
						<CardContent className={classes.cardContent}>
							<FormControl component="fieldset">
								...
								<RadioGroup
									...
									value={mfaType}
									onChange={(event) =>
										handleMfaTypeChange(event.target.value)
									}
									aria-label="mfaType"
						...
						<CardActions className={classes.cardActions}>
							{editMode && (
								<div>
									...
									>
										{I18n.get(
											"TAB_MFA_DATA_SAVE_BUTTON_LABEL"
										)}
									</Button>
									<Button
										variant="outlined"
									...
									>
										{I18n.get(
											"TAB_MFA_DATA_CANCEL_BUTTON_LABEL"
										)}
									</Button>
								</div>
							)}

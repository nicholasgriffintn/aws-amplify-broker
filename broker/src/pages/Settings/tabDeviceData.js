	...
	const handleClickRemember = () => {
		try {
			...
			setSnackBarOps({
				...
				autoHide: 3000,
				message: remember
					? I18n.get("TAB_DEVICE_DATA_REMEMBER_DEVICE_MESSAGE")
					: I18n.get("TAB_DEVICE_DATA_FORGET_DEVICE_MESSAGE"),
			});
		} catch (error) {
			console.error(error);
		...
		<div>
			...
			<div className={classes.divCard}>
				<Card variant="outlined" className={classes.card}>
					<CardHeader
						title={device.key}
						avatar={<PermDeviceInformationIcon />}
						action={
							<div className={classes.cardHeaderAction}>
								{device.current && (
									<Chip
										label={I18n.get(
											"TAB_DEVICE_DATA_CHIP_CURRENT_LABEL"
										)}
										size="small"
					...
					<Collapse in={device.expanded} timeout="auto" unmountOnExit>
							...
							<form noValidate autoComplete="off">
								<Box>
									<TextField
										...
										disabled
										label={I18n.get(
											"TAB_DEVICE_DATA_TEXTFIELD_STATUS_LABEL"
										)}
								...
								<Box>
									<TextField
										id="textfield_name"
										value={
											device.remembered ? device.name : ""
										}
										inputProps={{ style: { left: 0 } }}
										disabled
										label={I18n.get(
											"TAB_DEVICE_DATA_TEXTFIELD_NAME_LABEL"
										)}
										className={classes.textField}
									/>
								</Box>
								<Box>
									<TextField
										...
										disabled
										label={I18n.get(
											"TAB_DEVICE_DATA_TEXTFIELD_LAST_IP_LABEL"
										)}
										className={classes.textField}
									/>
								</Box>
								<Box>
									<TextField
										...
										disabled
										label={I18n.get(
											"TAB_DEVICE_DATA_TEXTFIELD_LAST_USED_LABEL"
										)}
										className={classes.textField}
									/>
								</Box>
								...
								<Box>
									<TextField
										...
										disabled
										label={I18n.get(
											"TAB_DEVICE_DATA_TEXTFIELD_CREATED_LABEL"
										)}
										className={classes.textField}
									/>
								</Box>
						...
						<CardActions className={classes.cardActions}>
							...
							>
								{device.remembered
									? I18n.get(
											"TAB_DEVICE_DATA_BUTTON_FORGET_DEVICE_LABEL"
									  )
									: I18n.get(
											"TAB_DEVICE_DATA_BUTTON_REMEMBER_DEVICE_LABEL"
									  )}
							</Button>
						</CardActions>
					</Collapse>
						...
						<CardHeader
							...
							avatar={
								<PermDeviceInformationIcon
									id={`permDeviceInformationIcon-${index}`}
								/>
							}
							action={
								<div className={classes.cardHeaderAction}>

	...
	render() {
		return (
			<MuiThemeProvider theme={theme}>
				...
				<div className="sso_dashboard">
					{this.state.registeredClients &&
					this.state.registeredClients.length > 0 ? (
						<>
							<h1>Your connected applications</h1>

							<AppTiles
								appClients={this.state.registeredClients}
							/>
						</>
					) : (
						<h1>
							Please wait while we load your connected
							applications...
						</h1>
					)}
				</div>
